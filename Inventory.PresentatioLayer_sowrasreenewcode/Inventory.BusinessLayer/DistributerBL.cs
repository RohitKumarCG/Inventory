...
{           
    ...
    {
        private static bool ValidateDistributer(Distributer distributer)//method to validate distributer
        {
        ...
        public static bool AddDistributerBL(Distributer newDistributer)//method to validate adddistributer()
        {
        ...
        public static Distributer SearchDistributerBL(string searchDistributerID)//method to validate S
        {
        ...
        public static bool UpdateDistributerBL(Distributer updateGuest)//method to validate updatedistributer()
        {
        ...
        public static bool DeleteDistributerBL(string deleteDistributerID)//method to validate deleteDistributer()
        {
